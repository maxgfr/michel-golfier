...
const paragraphs = [
	...
	"Dans un quatrième ouvrage, « L'Homme et son devenir trois siècles de notes prises en Auvergne et ailleurs. », il puise dans des archives notariales sur l'Auvergne des XVIIème, XVIIIème et XIXème siècles, ainsi que dans diverses décisions de conseils municipaux du XIXème et début du XXème siècle. Plusieurs thèmes y sont abordés : l'Ancien Régime, la Révolution, l'industrialisation, le travail de la vigne, l'enseignement religieux et laïque, les deux guerres mondiales, mais aussi la condition de la femme d'hier à aujourd'hui et sa lente mais progressive indépendance. Le XXIème siècle n'est pas oublié, avec le terrorisme, l'écologie, l'exploitation des enfants, ainsi que les conflits contemporains, notamment l'invasion de l'Ukraine par la Russie.",
];
			...
			<Layout>
				...
				<Box textAlign="center" mb={12}>
					...
					>
						...
						<Text mx={4} color="brand.400" fontSize="lg">
							&#9671;
						</Text>
						<Box flex={1} maxW="60px" h="1px" bg="brand.300" />
					</Box>
