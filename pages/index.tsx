    ...
    <>
      ...
      >
        ...
        <Book
          ...
          summary={[
            "Cet ouvrage tire ses origines des archives notariale sur l’Auvergne du XVIIème, XVIIIème et XIXème siècles, ainsi que sur diverses décisions de conseils municipaux du XIXème et début XXème siècle.",
            ...
            "Le XXIème siècle n’est pas oublié, d’autres événements sont aussi présents dans cet ouvrage tel que : Le terrorisme, l’écologie, l’exploitation des enfants au travail, (subissant aussi les abus des prédateurs.) Conflits et bruits de bottes sur différentes frontières de notre planète, avec notamment l’invasion de l’Ukraine par la Russie.",
