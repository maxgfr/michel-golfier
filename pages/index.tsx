    ...
    <>
      ...
      >
        ...
        <Book
          ...
          summary={[
            "Ce livre de 284 pages fera l'objet d'une prochaine publication au cours de l'année 2022, il comportera plus de 200 reproductions anciennes d'archives, de cartes postales, plans du cadastre napoléonien, graphiques, etc. Contactez-moi via le formulaire de contact, si vous êtes intéressés.",
