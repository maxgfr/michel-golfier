...
export const Book2017: Book = {
  ...
  additionalInformation:
    "<em>Le livre est disponible à l'achat sur Amazon en cliquant <a href='https://www.amazon.fr/Quelques-prises-Plauzat-villages-voisins/dp/B0CL5JG19D/' target='_blank'>ici</a></em>",
  images: [
    {
